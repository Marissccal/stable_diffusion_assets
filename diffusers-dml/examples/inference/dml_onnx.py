...
prompt = "Going Viking in an infinite war, photorealistic, trending artstation"
image = pipe(prompt, height=512, width=512, num_inference_steps=5, guidance_scale=10, eta=0.0, execution_provider="DmlExecutionProvider")["sample"][0]
image.save("astronaut-3.png")
